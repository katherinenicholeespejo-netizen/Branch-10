...
<?php if (isset($errors['auth'])): ?>
    <p style="color: red; font-weight: bold;"><?= $errors['auth'] ?></p>
<?php endif; ?>
...
<form action="/ite3/login" method="POST" style="max-width: 400px;">
    <div style="margin-bottom: 1rem;">
        ...
        <?php if (isset($errors['username'])): ?>
            <span style="color: red; font-size: 0.8rem;"><?= $errors['username'] ?></span>
        <?php endif; ?>
    </div>
    ...
    <div style="margin-bottom: 1rem;">
        ...
        <?php if (isset($errors['password'])): ?>
            <span style="color: red; font-size: 0.8rem;"><?= $errors['password'] ?></span>
        <?php endif; ?>
    </div>
